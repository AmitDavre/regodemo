									...
									<tr>
										...
										<td>
											<select name="default_team" style="width:100%">
													...
													<option   <? if($settings['default_team'] == $emp_grpDefaults['team']['code']){echo 'selected';}?> value="<?php echo $emp_grpDefaults['team']['code'] ; ?>"><?php echo $emp_grpDefaults['team']['en'] ; ?></option>
											</select>
										</td>
									</tr>										
									<tr>
										...
										<td>
											<select name="entity" style="width:100%">
													<option  value="select">Select</option>
													<option   <? if($settings['entity'] == $emp_grpDefaults['company']['code']){echo 'selected';}?> value="<?php echo $emp_grpDefaults['company']['code'] ; ?>"><?php echo $emp_grpDefaults['company']['en'] ; ?></option>
											</select>
										</td>
									</tr>				
									<tr>
										...
										<td>
											<select name="location" style="width:100%">
													<option  value="select">Select</option>
													<option   <? if($settings['location'] == $emp_grpDefaults['location']['code']){echo 'selected';}?> value="<?php echo $emp_grpDefaults['location']['code'] ; ?>"><?php echo $emp_grpDefaults['location']['en'] ; ?></option>
											</select>
										</td>
									</tr>			
									<tr>
										...
										<td>
											<select name="division" style="width:100%">
													<option  value="select">Select</option>
													<option   <? if($settings['division'] == $emp_grpDefaults['division']['code']){echo 'selected';}?> value="<?php echo $emp_grpDefaults['division']['code'] ; ?>"><?php echo $emp_grpDefaults['division']['en'] ; ?></option>
											</select>
										</td>
									</tr>		
									<tr>
										...
										<td>
											<select name="department" style="width:100%">
													<option  value="select">Select</option>
													<option   <? if($settings['department'] == $emp_grpDefaults['department']['code']){echo 'selected';}?> value="<?php echo $emp_grpDefaults['department']['code'] ; ?>"><?php echo $emp_grpDefaults['department']['en'] ; ?></option>
											</select>
										</td>
									</tr>
									<!-- <tr>
									...
									<tr>
										...
										<td>
											<select name="headoflocation" style="width:100%">
												<option <? if($settings['headoflocation'] == 'noresp'){echo 'selected';}?> value="noresp"><?=$lng['No Responsibility']?></option>
												<option   <? if($settings['headoflocation'] == $emp_grpDefaults['location']['code']){echo 'selected';}?> value="<?php echo $emp_grpDefaults['location']['code'] ; ?>"><?php echo $emp_grpDefaults['location']['en'] ; ?></option>
									...
									<tr>
										...
										<td>
											<select name="headofdivision" style="width:100%">
												<option <? if($settings['headofdivision'] == 'noresp'){echo 'selected';}?> value="noresp"><?=$lng['No Responsibility']?></option>
												<option   <? if($settings['headofdivision'] == $emp_grpDefaults['division']['code']){echo 'selected';}?> value="<?php echo $emp_grpDefaults['division']['code'] ; ?>"><?php echo $emp_grpDefaults['division']['en'] ; ?></option>
									...
									<tr>
										...
										<td>
											<select name="headofdepartment" style="width:100%">
												<option <? if($settings['headofdepartment'] == 'noresp'){echo 'selected';}?> value="noresp"><?=$lng['No Responsibility']?></option>
												<option   <? if($settings['headofdepartment'] == $emp_grpDefaults['department']['code']){echo 'selected';}?> value="<?php echo $emp_grpDefaults['department']['code'] ; ?>"><?php echo $emp_grpDefaults['department']['en'] ; ?></option>
									...
									<tr>
										...
										<td>
											<select name="headofsupervisor" style="width:100%">
												<option  <? if($settings['headofsupervisor'] == 'noresp'){echo 'selected';}?>  value="noresp"><?=$lng['No Responsibility']?></option>
												<option   <? if($settings['headofsupervisor'] == $emp_grpDefaults['team']['code']){echo 'selected';}?> value="<?php echo $emp_grpDefaults['team']['code'] ; ?>"><?php echo $emp_grpDefaults['team']['en'] ; ?></option>
