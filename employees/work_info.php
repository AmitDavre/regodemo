...
<style type="text/css">
	...
	<div class="pannel main_pannel">
		...
		<ul class="nav nav-tabs">
			...
			<li class="nav-item"><a class="nav-link active" href="#tab_work" data-toggle="tab"><?=$lng['Work']?></a></li>
			<li class="nav-item"><a class="nav-link" href="#tab_time" data-toggle="tab"><?=$lng['Time']?></a></li>
			<li class="nav-item"><a class="nav-link" href="#tab_leave" data-toggle="tab"><?=$lng['Leave']?></a></li>
			<li class="nav-item"><a class="nav-link" href="#tab_medical" data-toggle="tab"><?=$lng['Medical']?></a></li>
			<li class="nav-item"><a class="nav-link" href="#tab_discipline" data-toggle="tab"><?=$lng['Discipline']?></a></li>
		</ul>
							...
							<table class="basicTable editTable" border="0">
								<thead>
									<tr style="line-height:100%">
										<th colspan="2"><?=$lng['WORK DATA']?>
										<a class="text-success float-right" id="openEmploymentPopup"><i class="fa fa-edit font-weight-bold  fa-lg"></i></a></th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<th><?=$lng['Joining date']?></th>
										<td><input disabled style="cursor:pointer" class="datepick" type="text" name="joining_date" id="joining_date_readonly" placeholder="..." value="<? if(!empty($data['joining_date'])){echo date('d-m-Y', strtotime($data['joining_date']));}?>"></td>
									</tr>
									<tr>
										<th><?=$lng['Probation due date']?></th>
										<td><input type="text" disabled style="cursor:pointer" class="datepick" name="probation_date" id="probation_date" placeholder="..." value="<? if(!empty($data['probation_date'])){echo date('d-m-Y', strtotime($data['probation_date']));}?>"></td>
									</tr>
									<tr>
				...
				<div class='tabw' >
					<table class="basicTable editTable" border="0">
						...
						<tr>
							<th><?='Employment End date'?></th>
							<td>
								<input disabled class='datepick' type="text" style="cursor:pointer;width:140px;" name="resign_date" placeholder="..." value="<? if(!empty($data['resign_date'])){echo date('d-m-Y', strtotime($data['resign_date']));}?>">
