<?php
	...
	$getpayroll = $dbc->query("SELECT * FROM ".$sessionpayrollDbase." WHERE emp_id IN ('".$implodeids."') AND month = '".$_SESSION['rego']['cur_month']."' ");
